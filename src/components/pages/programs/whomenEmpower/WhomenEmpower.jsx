           ...
           <div className="row">
             <div className="col-12">
               ...
               <p>Our organisation has plans to offer a comprehensive training program in fashion designing to a group of 25+ women. This program will be conducted by highly skilled trainers who are experts in the field of fashion designing. The program will cover a wide range of topics, including design concepts, fabric selection, garment construction, pattern-making, and more.
                ...
                <p>Overall, our goal is to provide these women with the resources they need to succeed in the fashion industry, and we believe that this program will be an important step towards achieving that goal.</p>
             </div>
           </div>
         </div>
       </section>
           ...
           <div className="row">
             <div className="col-12">
               <h3>THE DAILY PROBLEMS OF 200 WOMEN WILL BE ADDRESSED AND SOLUTIONS WILL BE PROVIDED.</h3>
                ...
                <p>Once we have identified the key challenges faced by these women, we will work with experts in relevant fields to design and implement targeted solutions. For example, we may partner with healthcare providers to offer free or low-cost medical check-ups and treatments, or collaborate with local businesses to provide job training and placement services.</p>

                <p>In addition to addressing immediate challenges, we will also work to empower these women to become self-sufficient and build sustainable livelihoods. This may include offering entrepreneurship training, financial literacy education, and access to microloans or other forms of financing to help women start their own businesses.</p>

                <p>Overall, our goal is to provide comprehensive support to these 200 women, addressing the daily problems they face and equipping them with the tools they need to build better lives for themselves and their families. We believe that by empowering women, we can create positive change that ripples throughout communities and beyond.</p>
           ...
           <div className="row">
             <div className="col-12">
               <h3>OUR NGO HAS BEEN GIVEN A CONTRACT FOR THE FORMATION OF 1200 SELF HELP GROUPS IN THE FARIDABAD AREA. OUR 1ST SHG WAS FORMED IN BALLABGARH</h3>
                ...
                <p>To begin with, we established our first SHG in Ballabgarh, which serves as a model for the others that will follow. We have worked closely with community members to identify potential members for the SHG, and have provided training on the basics of group management and financial planning.</p>

                <p>Going forward, we will continue to work closely with local communities to form additional SHGs in the area. Each group will have its own unique focus, whether it be on business development, women's empowerment, or other areas of interest. We will also provide ongoing training and support to these groups, to ensure that they are able to thrive and achieve their goals.</p>

                <p>Through the formation of these SHGs, we hope to create a sense of community and shared purpose among local residents. By working together, we can help to address local challenges, promote economic development, and build a stronger, more sustainable community for all.</p>
